...
<ul>You can have a <a href = "https://github.com/KnightNine/ManorDB/releases/tag/v1.5.12-beta"> foreign key refrence column that is linked to a parent subtable</a>. </ul>
    </li>
  </ul>
</ul>
