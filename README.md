...
<p/>
<ul>
  <li> Bugfix needed: coppying from a text cell within a subtable using ctrl+c doesn't give the actual text within that cell, unsure as to why but this will need to get fixed soon (edit: a workaround to this is to only highlight the text cell by clicking it once but not entering where you can edit the text, and then pressing ctrl+c )</li>
